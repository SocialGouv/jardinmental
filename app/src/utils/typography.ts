export const typography = {
  ...
  textMdRegular: "text-md font-normal font-body text-center",
  textMdSemibold: "text-md font-semibold font-body leading-6",
  textMdMedium: "text-md font-normal font-body leading-6",
  textMdBold: "text-md font-bold font-body leading-6",

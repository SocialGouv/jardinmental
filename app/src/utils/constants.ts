...
export const STORAGE_KEY_NEW_USER = "@IS_NEW_USER";
export const STORAGE_INFO_MODAL_DISMISSED = "@INFO_MODAL_DISMISSED_1.43.3"; // info modal for new version 1.43.3
export const STORAGE_KEY_VIEWED_EXTERNAL_RESOURCES = "@VIEWED_EXTERNAL_RESOURCES";
export const STORAGE_KEY_VIEWED_RESOURCES = "@VIEWED_RESOURCES";
export const STORAGE_KEY_VIEWED_TOOL_ITEMS = "@VIEWED_TOOL_ITEMS";
export const STORAGE_KEY_AUTOMATICALLY_SET_BECK_AS_FAVORITE = "@STORAGE_KEY_AUTOMATICALLY_SET_BECK_AS_FAVORITE";
export const STORAGE_KEY_LAST_EXPORT_DATE = "@LAST_EXPORT_DATE";
export const EXPORT_REMINDER_LAST_SHOWN_KEY = "@EXPORT_REMINDER_LAST_SHOWN_KEY";
export const STORAGE_KEY_CHECKLIST_DATA_EXPORT_DONE = "@CHECKLIST_DATA_EXPORT_DONE";

...
export const INDICATEUR_DUREE_DU_SOMMEIL = {
...
export const INDICATEUR_ANXIETE = {
  name: "Anxiété",
...
export const INDICATEUR_REVEIL_PRECOCE = {
...
export const INDICATEUR_FATIGUE = {
  name: "Fatigue",
  priority: 0,
...
export const INDICATEUR_REVEIL_NOCTURNE = {
  name: "Réveils nocturnes",
  priority: 0,
  categories: [NEW_INDICATORS_CATEGORIES.SLEEP],
  subcategories: [NEW_INDICATORS_SUBCATEGORIES.SLEEP_DIFFICULTY],
...
export const INDICATEUR_RUMINATION = {
  name: "Ruminations",
...
export const INDICATEUR_DIFFICULTE_ENDORMISSEMENT = {
...
export const INDICATEUR_CONFIANCE_EN_SOI = {
...
export const INDICATEUR_TRISTESSE = {
  name: "Tristesse",
  categories: [NEW_INDICATORS_CATEGORIES.EMOTIONS],
  subcategories: [NEW_INDICATORS_SUBCATEGORIES.NEGATIVE_EMOTIONS],
  priority: 0,
...
export const INDICATEUR_MOTIVATION = {
  name: "Motivation",
...
export const INDICATEUR_CONSOMMATION_DE_CANNABIS = {
...
export const INDICATEUR_DIFFICULTE_ATTENTION = {
...
export const INDICATEUR_APPETIT = {
...
export const INDICATEUR_STABILITE_HUMEUR = {
...
export const INDICATEUR_QUALITE_DES_INTERACTIONS = {
...
export const INDICATEUR_DIFFICULTE_MEMORISATION = {
...
export const INDICATEUR_IDEES_SUICIDAIRES = {
...
export const INDICATEUR_STRESS = {
  name: "Stress",
...
export const INDICATEUR_EVENEMENT_DE_VIE_DIFFICILE = {
...
export const INDICATEUR_COLERE = {
  name: "Colère",
  categories: [NEW_INDICATORS_CATEGORIES.EMOTIONS],
  subcategories: [NEW_INDICATORS_SUBCATEGORIES.NEGATIVE_EMOTIONS],
  priority: 1,
...
export const INDICATEUR_CULPABILITE = {
  name: "Culpabilité",
  categories: [NEW_INDICATORS_CATEGORIES.EMOTIONS],
  subcategories: [NEW_INDICATORS_SUBCATEGORIES.NEGATIVE_EMOTIONS],
  priority: 1,
...
export const INDICATEUR_MAL_AU_VENTRE = {
  name: "Mal au ventre",
...
export const INDICATEUR_BOULIMIE = {
...
export const INDICATEUR_PERTE_DEMPLOI = {
...
export const INDICATEUR_CRAVING = {
  name: "Craving",
...
export const INDICATEUR_AUTRES_COMPORTEMENTS_A_RISQUE = {
...
export const INDICATEUR_COMPORTEMENTS_SEXUELS_A_RISQUE = {
...
export const INDICATEUR_CONSOMMATION_DANXIOLYTIQUE = {
...
export const INDICATEUR_CONSOMMATION_TABAC = {
...
export const INDICATEUR_CONSOMMATION_JEUX_ARGENT = {
...
export const INDICATEUR_ADDICTION_SEXUELLE = {
...
export const INDICATEUR_CONSOMMATION_JEUX_VIDEOS = {
...
export const INDICATORS: PredefineIndicatorV2SchemaType[] = [
  ...
  //   mainCategory: NEW_INDICATORS_CATEGORIES.SLEEP
  // },
  INDICATEUR_DUREE_DU_SOMMEIL,
  INDICATEUR_DIFFICULTE_ENDORMISSEMENT,
  INDICATEUR_REVEIL_NOCTURNE,
  INDICATEUR_REVEIL_PRECOCE,
  {
    priority: 1,
  ...
  INDICATEUR_FATIGUE,
  INDICATEUR_CONSOMMATION_DANXIOLYTIQUE,
  INDICATEUR_CONSOMMATION_DE_CANNABIS,
  {
    priority: 1,
  ...
  INDICATEUR_COMPORTEMENTS_SEXUELS_A_RISQUE,
  {
  ...
  INDICATEUR_AUTRES_COMPORTEMENTS_A_RISQUE,
  INDICATEUR_STRESS,
  {
  ...
  {
    name: "Trouble d'idéation\nDifficulté à organiser ses pensées, à planifier...",
    categories: [NEW_INDICATORS_CATEGORIES.COGNITIVE],
    priority: 1,
    order: "DESC",
    type: INDICATOR_TYPE.gauge,
  ...
  INDICATEUR_TRISTESSE,
  INDICATEUR_CULPABILITE,
  {
    name: "Humeur matinale",
    categories: [NEW_INDICATORS_CATEGORIES.EMOTIONS],
    subcategories: [NEW_INDICATORS_SUBCATEGORIES.EMOTIONAL_STABILITY],
  ...
  INDICATEUR_ANXIETE,
  INDICATEUR_MOTIVATION,
  INDICATEUR_RUMINATION,
  INDICATEUR_IDEES_SUICIDAIRES,
  {
  ...
  INDICATEUR_CRAVING,
  INDICATEUR_CONSOMMATION_JEUX_ARGENT,
  INDICATEUR_ADDICTION_SEXUELLE,
  INDICATEUR_CONSOMMATION_JEUX_VIDEOS,
  INDICATEUR_ECRAN,
  // {
  ...
  INDICATEUR_QUALITE_DES_INTERACTIONS,
  {
  ...
  INDICATEUR_EVENEMENT_DE_VIE_DIFFICILE,
  {
  ...
  INDICATEUR_DIFFICULTE_ATTENTION,
  INDICATEUR_DIFFICULTE_MEMORISATION,
];
...
export const INDICATORS_COUPLES = [
  [INDICATEURS_SOMMEIL, INDICATEUR_ANXIETE],
  [INDICATEURS_SOMMEIL, INDICATEUR_CONSOMMATION_TABAC],
  [INDICATEURS_SOMMEIL, INDICATEUR_CONSOMMATION_JEUX_ARGENT],
  [INDICATEURS_SOMMEIL, INDICATEUR_ADDICTION_SEXUELLE],
  [INDICATEURS_SOMMEIL, INDICATEUR_CONSOMMATION_JEUX_VIDEOS],
  [INDICATEURS_SOMMEIL, INDICATEUR_ECRAN],
  [INDICATEURS_SOMMEIL, NEW_INDICATORS_CATEGORIES.SUBSTANCE],
  //
  [INDICATEURS_HUMEUR, INDICATEUR_ANXIETE],
  [INDICATEURS_HUMEUR, NEW_INDICATORS_CATEGORIES.SUBSTANCE],
  //
  [INDICATEUR_ANXIETE, INDICATEUR_DUREE_DU_SOMMEIL],
  [INDICATEUR_ANXIETE, INDICATEUR_REVEIL_PRECOCE],
  //f
  [INDICATEUR_FATIGUE, INDICATEUR_ANXIETE],
  [INDICATEUR_FATIGUE, INDICATEURS_SOMMEIL],
  [INDICATEUR_FATIGUE, INDICATEUR_DUREE_DU_SOMMEIL],
  [INDICATEUR_FATIGUE, INDICATEUR_REVEIL_NOCTURNE],
  //
  [INDICATEUR_RUMINATION, INDICATEUR_FATIGUE],
  [INDICATEUR_RUMINATION, INDICATEUR_ANXIETE],
  [INDICATEUR_RUMINATION, INDICATEURS_SOMMEIL],
  [INDICATEUR_RUMINATION, INDICATEUR_REVEIL_NOCTURNE],
  [INDICATEUR_RUMINATION, INDICATEUR_DIFFICULTE_ENDORMISSEMENT],
  [INDICATEUR_RUMINATION, INDICATEUR_CONFIANCE_EN_SOI],
  //
  [INDICATEUR_TRISTESSE, INDICATEUR_ANXIETE],
  //
  [INDICATEUR_REVEIL_NOCTURNE, INDICATEUR_ANXIETE],
  //
  [INDICATEUR_MOTIVATION, INDICATEUR_FATIGUE],
  [INDICATEUR_MOTIVATION, INDICATEUR_CONSOMMATION_DE_CANNABIS],
  //
  [INDICATEUR_DIFFICULTE_ATTENTION, INDICATEUR_TRISTESSE],
  [INDICATEUR_DIFFICULTE_ATTENTION, INDICATEUR_ANXIETE],
  [INDICATEUR_DIFFICULTE_ATTENTION, INDICATEURS_SOMMEIL],
  //
  [INDICATEUR_APPETIT, INDICATEUR_FATIGUE],
  [INDICATEUR_APPETIT, INDICATEURS_HUMEUR],
  [INDICATEUR_APPETIT, INDICATEUR_ANXIETE],
  [INDICATEUR_APPETIT, NEW_INDICATORS_CATEGORIES.EMOTIONS],
  //
  [INDICATEUR_STABILITE_HUMEUR, INDICATEUR_FATIGUE],
  [INDICATEUR_STABILITE_HUMEUR, INDICATEURS_SOMMEIL],
  [INDICATEUR_STABILITE_HUMEUR, INDICATEUR_ANXIETE],
  [INDICATEUR_STABILITE_HUMEUR, NEW_INDICATORS_CATEGORIES.SUBSTANCE],
  //
  [INDICATEUR_QUALITE_DES_INTERACTIONS, INDICATEUR_FATIGUE],
  [INDICATEUR_QUALITE_DES_INTERACTIONS, INDICATEURS_HUMEUR],
  [INDICATEUR_QUALITE_DES_INTERACTIONS, INDICATEUR_ANXIETE],
  //
  [INDICATEUR_DIFFICULTE_MEMORISATION, INDICATEUR_FATIGUE],
  [INDICATEUR_DIFFICULTE_MEMORISATION, INDICATEURS_HUMEUR],
  [INDICATEUR_DIFFICULTE_MEMORISATION, INDICATEUR_ANXIETE],
  //
  [INDICATEUR_REVEIL_PRECOCE, INDICATEURS_HUMEUR],
  //
  [INDICATEUR_IDEES_SUICIDAIRES, INDICATEURS_HUMEUR],
  [INDICATEUR_IDEES_SUICIDAIRES, INDICATEUR_TRISTESSE],
  [INDICATEUR_IDEES_SUICIDAIRES, INDICATEUR_ANXIETE],
  [INDICATEUR_IDEES_SUICIDAIRES, INDICATEUR_STRESS],
  [INDICATEUR_IDEES_SUICIDAIRES, INDICATEUR_EVENEMENT_DE_VIE_DIFFICILE],
  //
  [INDICATEUR_EVENEMENT_DE_VIE_DIFFICILE, INDICATEURS_HUMEUR],
  [INDICATEUR_EVENEMENT_DE_VIE_DIFFICILE, INDICATEUR_TRISTESSE],
  [INDICATEUR_EVENEMENT_DE_VIE_DIFFICILE, INDICATEUR_TRISTESSE],
  //
  [INDICATEUR_COLERE, INDICATEURS_HUMEUR],
  [INDICATEUR_COLERE, INDICATEUR_ANXIETE],

  [INDICATEUR_CULPABILITE, INDICATEUR_TRISTESSE],
  [INDICATEUR_CONFIANCE_EN_SOI, INDICATEUR_ANXIETE],
  [INDICATEUR_DIFFICULTE_ENDORMISSEMENT, INDICATEUR_ANXIETE],
  [INDICATEUR_MAL_AU_VENTRE, INDICATEUR_ANXIETE],
  //
  [INDICATEUR_BOULIMIE, INDICATEUR_TRISTESSE],
  [INDICATEUR_BOULIMIE, INDICATEURS_HUMEUR],
  [INDICATEUR_BOULIMIE, INDICATEUR_ANXIETE],
  [INDICATEUR_BOULIMIE, INDICATEUR_STRESS],
  //
  [INDICATEUR_PERTE_DEMPLOI, INDICATEUR_ANXIETE],
  [INDICATEUR_PERTE_DEMPLOI, INDICATEUR_CONFIANCE_EN_SOI],
  [INDICATEUR_PERTE_DEMPLOI, INDICATEUR_MOTIVATION],
  //
  [INDICATEUR_CONSOMMATION_DE_CANNABIS, INDICATEUR_ANXIETE],
  [INDICATEUR_CONSOMMATION_DE_CANNABIS, INDICATEURS_HUMEUR],
  //
  [INDICATEUR_CRAVING, INDICATEURS_HUMEUR],
  [INDICATEUR_CRAVING, INDICATEURS_SOMMEIL],
  [INDICATEUR_CRAVING, INDICATEUR_ANXIETE],
  [INDICATEUR_CRAVING, INDICATEUR_EVENEMENT_DE_VIE_DIFFICILE],
  //
  [INDICATEUR_AUTRES_COMPORTEMENTS_A_RISQUE, INDICATEURS_HUMEUR],
  [INDICATEUR_COMPORTEMENTS_SEXUELS_A_RISQUE, INDICATEURS_HUMEUR],
  [INDICATEUR_CONSOMMATION_DANXIOLYTIQUE, INDICATEURS_SOMMEIL],
  [INDICATEUR_CONSOMMATION_DANXIOLYTIQUE, INDICATEUR_ANXIETE],
];

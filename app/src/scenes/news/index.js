    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView style={styles.cgu} contentContainerStyle={styles.scrollContainer}>
        ...
        <Card title="Amélioration des notifications de rappel" version="v1.35" date="11/2022">
          <Item>
            <Text style={styles.text}>
              Le système de notifications de rappel à été amélioré ! Pensez à bien autoriser les notifications et les bannières de Jardin Mental dans les réglages de votre
              téléphone.
            </Text>
          </Item>
        </Card>
        <Card title="Amélioration de l'analyse et recommandation" version="v1.34" date="05/2022">
          ...
          <Item>
            <Text style={styles.text}>
              Mes Analyses&nbsp;:
              {'\n'}Utilisez le sélecteur de date pour retrouver rapidement la période qui vous intéresse. Si besoin, vous pouvez toujours sélectionner manuelle une date de début
              et une date de fin pour une période personnalisé. Les filtres par intensité ainsi que pour afficher vos prises de traitements sur vos frises sont maintenant
              accessibles via le bouton «&nbsp;filtres&nbsp;».
            </Text>
          </Item>
        </Card>
        ...
        <Card title="Mon Suivi Psy change de présentation et vous propose de nouveaux exemples d'éléments à suivre dans votre questionnaire." version="v1.24" date="03/2022">
          <Item>
            ...
            <Text style={styles.text}>
              ...
              {'\n'}•&nbsp;Vos <Text style={styles.bold}>notes personnelles</Text> (qui correspondent aux précisions et au contexte général que vous saisissez dans votre
              questionnaire)
            </Text>
          </Item>
          <Item>
            <Text style={styles.text}>Vous retrouvez dans «&nbsp;Mes&nbsp;analyses&nbsp;» tous vos outils&nbsp;: frises, courbes, statistiques et analyses de notes</Text>
          </Item>
          <Item>
            <Text style={styles.text}>
        ...
        <Card title="Fonction «&nbsp;Évènements&nbsp;» dans «&nbsp;Mon&nbsp;Suivi&nbsp;» : identifiez les évènements qui influent sur vos ressentis" version="v1.22" date="03/2022">
          ...
          <Item>
            <Text style={styles.text}>
              Les évènements correspondent aux précisions (contexte de la journée et pour chaque élément) que vous renseignez dans le questionnaire de «&nbsp;Mon&nbsp;Etat&nbsp;»
            </Text>
          </Item>
        </Card>
        <Card title="Mon Suivi s'étoffe avec l'écran «&nbsp;Frises&nbsp;» et validez votre questionnaire à tout moment" version="v1.21" date="03/2022">
          <Item>
            <Text style={styles.text}>
              Vous pouvez maintenant valider votre questionnaire sans avoir renseigné tous ses éléments, ce qui vous permet de le remplir progressivement au cours de la journée.
            </Text>
          </Item>
          <Item>
            <Text style={styles.text}>
        ...
        <Card title="Les colonnes de Beck !" version="v1.14" date="07/2021">
          <Item>
            <Text style={styles.text}>
              Apprenez à <Text style={styles.bold}>identifier</Text>, <Text style={styles.bold}>comprendre</Text> et <Text style={styles.bold}>gérer</Text> vos pensées et vos
              émotions au quotidien.
            </Text>
          </Item>
          <Item>
            <Text style={styles.text}>
              Cette nouvelle fonctionnalité vous permet de mieux identifer des <Text style={styles.bold}>situations</Text> et vos <Text style={styles.bold}>émotions</Text> qui en
              découlent.
            </Text>
          </Item>
        </Card>

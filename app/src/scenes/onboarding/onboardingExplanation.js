...
const ScreenStats = () => (
  <View style={styles.container}>
    <Text style={styles.presentationText}>
      Les <Text style={styles.bold}>statistiques</Text> vous donneront un bilan de chaque indicateur sur la période de votre choix, ainsi que votre
      observance de vos prises de traitement
    </Text>
...
const ScreenFriezes = () => (
  <View style={styles.container}>
    <Text style={styles.presentationText}>
      Les <Text style={styles.bold}>frises</Text> vous permettront de suivre l’évolution de vos indicateurs, de comprendre les corrélations entre eux,
      ainsi que les effets de votre traitement
    </Text>
...
const ScreenCurves = () => (
  <View style={styles.container}>
    <Text style={styles.presentationText}>
      Les <Text style={styles.bold}>courbes</Text> vous permettront de suivre votre évolution et de retrouver rapidement le détail de chaque journée
      en cliquant sur le point correspondant.
    </Text>
...
const ScreenTriggers = () => (
  <View style={styles.container}>
    <Text style={styles.presentationText}>
      Les <Text style={styles.bold}>déclencheurs</Text> vous aideront à comprendre ce qui influe sur votre état de santé mentale, en retrouvant vos
      notes personnelles liées à l’indicateur et son intensité de votre choix.
    </Text>

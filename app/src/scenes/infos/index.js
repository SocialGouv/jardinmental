            ...
            {isFullScreen ? (
              <>
                <Text style={styles.explanation}>
                  Quand on a un doute, quand on se pose la question, c’est toujours une bonne idée de consulter un professionnel de santé, qui saura nous informer et nous orienter.
                  {'\n\n'}
                  ...
                  {'\n'}
                  Il arrive qu’à certains moments de la vie, on se sente moins bien psychiquement. Notre santé mentale est alors moins bonne et l’on peut présenter un trouble
                  psychiatrique. Les troubles psychiatriques sont très fréquents, ils peuvent toucher n’importe qui à n’importe quel moment de la vie, surtout quand on se retrouve
                  dans des situations difficiles.{'\n\n'}
                  Le fait d’avoir un trouble psychiatrique n’a aucun rapport avec une quelconque faiblesse ou manque de volonté. C’est juste que parfois, pour plein de raisons
                  différentes, notre santé mentale est moins bonne, comme n’importe quelle autre composante de notre santé.
                  {'\n'}Les troubles psychiatriques se soignent, encore plus s’ils sont pris en charge rapidement. Quand on a un doute, quand on se pose la question, c’est toujours
                  une bonne idée de consulter un professionnel de santé, qui saura nous informer et nous orienter.
                </Text>

...
const Reminder = ({
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {!!route?.params?.onboarding && !!reminder && <JMButton onPress={deleteReminderManually} title="Désactiver le rappel"></JMButton>}
      ...
      {route?.params?.onboarding ? (
        ...
        <View style={styles.ctaContainer}>
          <JMButton onPress={showReminderSetup} className={"mb-5"} title={reminder ? "Modifier le rappel" : "Choisir l'heure du rappel"} />
          <JMButton
            variant="text"

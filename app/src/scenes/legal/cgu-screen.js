...
const CGU = ({navigation}) => {
  const content = (
    <View className="px-2">
      ...
      <Text className="text-blue-900 text-sm my-2">« Éditeur » désigne la personne morale qui met à la disposition du public l'Application, à savoir la DGS</Text>
      <Text className="text-blue-900 text-sm my-2">« Services » désigne les fonctionnalités proposées par l'Application pour répondre à ses finalités</Text>
      <Text className="text-blue-900 text-sm my-2">
      ...
      <Li>
        <Text className="text-blue-900 text-sm my-2">L'Utilisateur peut se fixer des objectifs à respecter et effectuer un suivi de ces derniers ;</Text>
      </Li>
      <Li>
        <Text className="text-blue-900 text-sm my-2">

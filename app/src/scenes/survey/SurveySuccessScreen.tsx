...
const ENCOURAGEMENT_MESSAGES: MotivationalMessage[] = [
  { id: 1, type: "encouragement", emoji: "👏", text: "Bravo : prendre le temps de remplir votre suivi, c'est déjà prendre soin de vous." },
  { id: 2, type: "encouragement", emoji: "🧩", text: "Chaque saisie est une petite pièce du puzzle de votre santé mentale." },
  ...
  { id: 5, type: "encouragement", emoji: "📈", text: "Observer vos indicateurs, c'est comprendre ce qui influence votre équilibre." },
  { id: 6, type: "encouragement", emoji: "💡", text: "En notant vos ressentis, vous créez un journal de votre bien-être." },
  { id: 7, type: "encouragement", emoji: "🙌", text: "Faire le point sur votre journée, c'est déjà un acte positif envers vous-même." },
  { id: 8, type: "encouragement", emoji: "🕰️", text: "Deux minutes pour remplir votre suivi = un temps précieux que vous vous accordez." },
  { id: 9, type: "encouragement", emoji: "🌙", text: "Même une petite observation aujourd'hui peut vous apporter des clés demain." },
  { id: 10, type: "encouragement", emoji: "💪", text: "Vous faites de votre bien-être une priorité, un pas après l'autre." },
  { id: 11, type: "encouragement", emoji: "🔍", text: "Chaque saisie est une observation qui compte." },
  { id: 12, type: "encouragement", emoji: "🎯", text: "Votre engagement à noter régulièrement renforce votre parcours personnel." },
  { id: 13, type: "encouragement", emoji: "🗝️", text: "L'auto-observation est une clé pour mieux comprendre ce qui agit sur vous." },
  { id: 14, type: "encouragement", emoji: "📊", text: "Chaque indicateur noté enrichit votre compréhension de vous-même." },
  { id: 15, type: "encouragement", emoji: "🤝", text: "Remplir votre suivi, c'est engager un dialogue bienveillant avec vous-même." },
  { id: 16, type: "encouragement", emoji: "🌞", text: "Observer aujourd'hui, c'est préparer un demain plus serein." },
  { id: 17, type: "encouragement", emoji: "🌍", text: "Vous contribuez à votre équilibre rien qu'en prenant ce moment." },
  { id: 18, type: "encouragement", emoji: "📝", text: "Noter vos ressentis, c'est prendre un temps pour les reconnaître." },
  { id: 19, type: "encouragement", emoji: "🔄", text: "La régularité fait toute la différence dans l'auto-observation." },
  { id: 20, type: "encouragement", emoji: "🌟", text: "Faire votre suivi, c'est déjà progresser." },
  ...
  { id: 23, type: "encouragement", emoji: "🚀", text: "Vous construisez une base solide en revenant jour après jour." },
  { id: 24, type: "encouragement", emoji: "💭", text: "L'auto-observation, c'est un espace pour écouter vos pensées." },
  { id: 25, type: "encouragement", emoji: "🧘", text: "Ce petit rituel quotidien nourrit votre équilibre intérieur." },
  { id: 26, type: "encouragement", emoji: "🎉", text: "Bravo pour votre engagement : chaque suivi est une victoire." },
  { id: 27, type: "encouragement", emoji: "📖", text: "Votre suivi est votre histoire, jour après jour." },
  { id: 28, type: "encouragement", emoji: "💬", text: "Noter vos ressentis, c'est apprendre à mieux dialoguer avec vous-même." },
  { id: 29, type: "encouragement", emoji: "🌈", text: "Faire votre suivi, c'est un geste simple mais puissant." },

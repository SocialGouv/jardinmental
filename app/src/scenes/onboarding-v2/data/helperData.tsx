...
export const INDICATOR_CATEGORIES_DATA: Record<NEW_INDICATORS_CATEGORIES, Difficulty> = {
  [NEW_INDICATORS_CATEGORIES.SLEEP]: {
    ...
    labelIndicatorScreen: "Prenons un instant pour observer vos ressentis liés à votre sommeil",
  ...
  [NEW_INDICATORS_CATEGORIES.EMOTIONS]: {
    ...
    labelIndicatorScreen: "Prenons un instant pour observer vos ressentis liés à votre humeur et vos émotions",
    selected: false,
  ...
  [NEW_INDICATORS_CATEGORIES.FOOD]: {
    ...
    labelIndicatorScreen: "Prenons un instant pour observer vos ressentis liés à votre alimentation",
  ...
  [NEW_INDICATORS_CATEGORIES.ENERGY]: {
    ...
    labelIndicatorScreen: "Prenons un instant pour observer vos ressentis liés à votre énergie",
    name: "Mon énergie",
    selected: false,
    label: "Énergie",
    icon: Zap,
  ...
  [NEW_INDICATORS_CATEGORIES.INTRUSIVE_THOUGHTS]: {
    ...
    labelIndicatorScreen: "Prenons un instant pour observer vos ressentis liés aux pensées qui prennent de la place",
  ...
  [NEW_INDICATORS_CATEGORIES.SUBSTANCE]: {
    ...
    labelIndicatorScreen: "Prenons un instant pour observer l’intensité de vos consommations ou de vos habitudes liées à une addiction",
    label: `Consommations de produits & addictions`,
    addIndicatorText: `Nommez le produit ou l'addiction`,
  ...
  [NEW_INDICATORS_CATEGORIES.PHYSICAL_SIGNS]: {
    ...
    labelIndicatorScreen: "Prenons un instant pour observer vos ressentis liés à votre état physique",
  ...
  [NEW_INDICATORS_CATEGORIES.SOCIAL_RELATIONS]: {
    ...
    labelIndicatorScreen: "Prenons un instant pour observer vos ressentis liés à vos relations avec les autres",
  ...
  [NEW_INDICATORS_CATEGORIES.WORK]: {
    ...
    labelIndicatorScreen: "Prenons un instant pour observer vos ressentis liés à votre rapport au travail",
    name: `Mon travail`,
    label: "Travail",
  ...
  [NEW_INDICATORS_CATEGORIES.LIFE_EVENT]: {
    ...
    labelIndicatorScreen: "Prenons un instant pour évaluer la charge émotionnelle que représente ce ou ces évènements pour vous aujourd’hui",
    ...
    addIndicatorText: `Nommez l'événement de vie difficile`,
    selected: false,
    icon: LifeEvent,
    matomoId: 8,
  },
  [NEW_INDICATORS_CATEGORIES.RISK_BEHAVIOR]: {
    ...
    labelIndicatorScreen: "Prenons un instant pour observer vos ressentis liés à vos comportements à risque ou impulsifs",
    ...
    addIndicatorText: `Nommez votre comportement à risque`,
    icon: AlertTriangle,
    matomoId: 10,
  },
  [NEW_INDICATORS_CATEGORIES.COGNITIVE]: {
    ...
    labelIndicatorScreen: "Prenons un instant pour observer vos ressentis liés à votre concentration ou vos facultés mentales",
    selected: false,
    icon: PuzzlePiece,

...
const OnboardingV2Navigator: React.FC = () => {
  ...
  const WrappedOnboardingPersonalizationStartScreen = useMemo(
    () =>
      ProgressScreen({
        slideIndex: 0,
  ...
  const WrappedDifficultiesScreen = useMemo(
    () =>
      ProgressScreen({
        slideIndex: 1,
        showProgressbar: true,
  ...
  const WrappedSubcategoriesScreen = useMemo(
    () =>
      ProgressScreen({
        slideIndex: 2,
        showProgressbar: true,
  ...
  return (
    ...
    >
      ...
      {/* Use header */}
      <Stack.Screen name="PersonalizationStart" options={headerOptions} component={WrappedOnboardingPersonalizationStartScreen} />
      <Stack.Screen name="PersonalizationDifficulties" options={headerOptions} component={WrappedDifficultiesScreen} />
      <Stack.Screen name="SubCategoriesScreen" options={headerOptions} component={WrappedSubcategoriesScreen} />
      <Stack.Screen name="OnboardingCheckInStart" component={OnboardingCheckInStartScreen} />
      <Stack.Screen name="OnboardingCheckInHowDoYouFeel" component={OnboardingCheckInHowDoYouFeelScreen} />
      <Stack.Screen name="OnboardingCheckInHowDoYouFeelDetails" component={OnboardingCheckInLastMoodsScreen} />
      <Stack.Screen name="OnboardingCheckInMoodSummary" component={OnboardingCheckInMoodSummaryScreen} />
      <Stack.Screen name="OnboardingCheckInSleep" component={OnboardingCheckInSleepScreen} />
      <Stack.Screen name="StartFirstSurvey" component={StartFirstSurvey} />
      <Stack.Screen name="CheckInSleepCompleted" component={CheckInSleepCompleted} />
      <Stack.Screen name="OnboardingChooseIndicatorIntro" component={OnboardingCheckInIntroductionCompletedScreen} />
      <Stack.Screen name="OnboardingLoadingScreen" component={OnboardingLoadingScreen} />
      <Stack.Screen name="OnboardingChooseIndicator" component={OnboardingChooseIndicatorScreen} />
    </Stack.Navigator>
  );
};

const OnboardingV2: React.FC = () => {
  return <OnboardingV2Navigator />;
};

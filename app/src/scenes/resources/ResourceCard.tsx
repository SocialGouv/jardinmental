...
const ResourceCard: React.FC<ResourceCardProps> = ({ resource, onPress }) => {
  return (
    <TouchableOpacity
      onPress={onPress}
      activeOpacity={0.7}
      className="text-cnam-primary-950 bg-white border p-2 border-cnam-primary-400 rounded-lg flex flex-row overflow-hidden mb-2"
    >
      ...
      <View className="flex-1 p-2 ml-1">
        <Text className="text-base font-semibold mb-2 text-cnam-primary-950">{resource.title}</Text>

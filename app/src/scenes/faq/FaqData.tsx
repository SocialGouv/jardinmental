  ...
  indicateurs: {
    ...
    accordion: [
      ...
      },
      {
        ...
        description: `Vous pouvez accéder aux paramétres de vos indicateurs soit lorsque vous remplissez votre questionnaire quotidien, soit depuis les *Paramètres généraux* (⚙️ en haut à droite) en cliquant sur « *Personnaliser mes indicateurs* » : 
...
\nLeur but est de vous aider à progresser pas à pas, pas de bousculer toutes vos habitudes d’un coup 😊`,
      ...
      {
        title: `Comment les paramétrer ?`,
        description: `Vous pouvez accéder aux paramétres de vos objectifs soit lorsque vous remplissez votre questionnaire quotidien, soit depuis les *Paramètres généraux* (⚙️ en haut à droite) en cliquant sur « *Personnaliser mes objectifs* » : 
    ...
    accordion: [
      {
        ...
        description: `Pour renseigner votre traitement, allez dans les *Paramètre généraux* (⚙️ en haut à droite) puis cliquez sur *« Saisir mon traitement ».* 

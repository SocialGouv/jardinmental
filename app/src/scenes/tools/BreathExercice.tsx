  ...
  return (
    <Background color="white" withSwiperContainer>
      <View className="h-full w-full bg-[#fff] ">
        ...
        >
          <ChevronIcon />
          <Typography className="ml-4 text-cnam-primary-950">Retour</Typography>
        </TouchableOpacity>
        <View className="h-full w-screen items-center flex flex-col">
          <Typography className="text-primary text-3xl font-bold absolute top-10 pr-2">
          ...
          <View className="h-full w-screen items-center flex flex-col justify-center">
            <Animated.View className="justify-center items-center" style={{ opacity: inhaleOpacity }}>
              <Typography className="text-cnam-primary-950 text-3xl font-bold absolute">Inspirez</Typography>
            </Animated.View>
            <Animated.View className="justify-center items-center" style={{ opacity: exhaleOpacity }}>
              <Typography className="text-cnam-primary-950 text-3xl font-bold text-center absolute">Expirez</Typography>
            </Animated.View>
            <Animated.View className="justify-center items-center" style={{ opacity: holdOpacity }}>
              <Typography className="text-cnam-primary-950 text-3xl font-bold text-center absolute">Maintenez</Typography>
            </Animated.View>
          ...
          <View className=" absolute bottom-16 flex-row justify-between w-full px-4">
            <View className="flex-row bg-primary rounded-lg items-center ">
              ...
              >
                <Typography className="text-white font-semibold ">-</Typography>
              </TouchableOpacity>
              <Typography className="text-white font-semibold ">respiration: {breathTime}s</Typography>
              <TouchableOpacity
                className="  p-2"
                onPress={() => {
                  setBreathTime(parseFloat((breathTime + 1).toFixed(1)));
            ...
            <View className="flex-row  bg-primary rounded-lg items-center">
              ...
              <Typography className="text-white font-semibold ">pause: {pause}s</Typography>
              <TouchableOpacity
                className="  p-2"
                onPress={() => {
                  setPause(parseFloat((pause + 1).toFixed(1)));

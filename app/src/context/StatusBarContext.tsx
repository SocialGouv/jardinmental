...
type StatusBarAction = { type: "SET_CUSTOM_COLOR"; payload: string } | { type: "SET_DEFAULT_COLOR"; payload: string } | { type: "RESET_TO_DEFAULT" };
...
export const StatusBarProvider: React.FC<StatusBarProviderProps> = ({ children }) => {
  ...
  return <StatusBarContext.Provider value={extendedContextValue as any}>{children}</StatusBarContext.Provider>;
};

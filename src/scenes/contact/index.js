  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.paragraph}>
          <Text style={styles.standardText}>
            Afin d'améliorer Mon Suivi Psy, nous serions ravis d'échanger avec
            vous :
          </Text>
          {/* // todo mailto */}
          <TouchableOpacity
        ...
        <View style={styles.paragraph}>
          <Text style={styles.bottomNote}>
            Mon Suivi Psy est une application développée avec des professionnels
            de santé. Néanmoins, les entretiens proposés ont uniquement pour

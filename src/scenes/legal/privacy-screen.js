...
const Privacy = ({navigation}) => {
  const content = (
    <View>
      ...
      <Text style={styles.default}>
        L'application «&nbsp;MonSuiviPsy&nbsp;» vise à accompagner les personnes
        qui le souhaitent à mieux connaître et suivre leurs symptômes, leurs
        ressentis ou toute activité personnalisée, leur permettant de faciliter
        leur accompagnement psychologique. L'application permet notamment&nbsp;:
      </Text>
      <Li>
        <Text style={styles.default}>
      ...
      <Text style={[styles.default, styles.bold]}>
        ...
        le terminal de l'utilisateur et ne sont pas transférées à l'équipe
      ...
      <Text style={styles.default}>
        ...
        auquel aura accès l'équipe de MonSuiviPsy.
      </Text>

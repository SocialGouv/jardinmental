...
const SymptomScreen = ({ navigation, route }) => {
  ...
  useEffect(() => {
    (async () => {
      ...
      console.log("🚀 ~ file: index.js ~ line 28 ~ preselectedCategories", preselectedCategories);
    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <Text style={styles.subtitle}>
          Sélectionnez ce que vous voulez suivre quotidiennement parmi ces exemples
        </Text>
        ...
        <View style={styles.buttonWrapper}>
          {noneSelected() ? (
            ...
            <Text style={[styles.h3, styles.spaceabove]}>
              Vous pourrez modifier à tout moment ce que vous suivez, via le menu “Réglages” de
              l’application
            </Text>
          )}
